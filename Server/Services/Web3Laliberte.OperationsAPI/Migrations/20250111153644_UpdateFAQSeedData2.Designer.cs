...
namespace Web3Laliberte.OperationsAPI.Migrations
{
    ...
    [Migration("20250111153644_UpdateFAQSeedData2")]
    partial class UpdateFAQSeedData2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Web3Laliberte.OperationsAPI.Model.ContactLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("98ddfcd0-e06c-424c-bf10-792f217819d3"),
                            CreatedAt = new DateTime(2025, 1, 11, 15, 36, 44, 226, DateTimeKind.Utc).AddTicks(474),
                        ...
                        new
                        {
                            Id = new Guid("e5ab157e-8d3c-4c73-be61-9fd54855c375"),
                            CreatedAt = new DateTime(2025, 1, 11, 15, 36, 44, 226, DateTimeKind.Utc).AddTicks(486),
                        ...
                        new
                        {
                            Id = new Guid("fcbebee8-6891-49bc-9d79-24badfc78b10"),
                            CreatedAt = new DateTime(2025, 1, 11, 15, 36, 44, 226, DateTimeKind.Utc).AddTicks(497),
            ...
            modelBuilder.Entity("Web3Laliberte.OperationsAPI.Model.Orders.Gift", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GiftId = new Guid("94f377da-4fae-41db-b859-b5c52d00e0e4"),
                            BandId = 1,
                        ...
                        new
                        {
                            GiftId = new Guid("b204917a-57e4-4e63-b476-e9a892b21ca6"),
                            BandId = 1,
                        ...
                        new
                        {
                            GiftId = new Guid("3b143465-b509-4bbd-bd2c-f3b899742dfc"),
                            BandId = 2,
                        ...
                        new
                        {
                            GiftId = new Guid("c5163852-5fda-4ba4-a3d4-b817b392793e"),
                            BandId = 3,
                        ...
                        new
                        {
                            GiftId = new Guid("d71d7cd9-3a2a-473f-85b6-e93061f7022d"),
                            BandId = 3,
            ...
            modelBuilder.Entity("Web3Laliberte.OperationsAPI.Model.Orders.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TransactionId = new Guid("6145dace-72a2-48e0-89df-9dc585b22378"),
                            AddressLine1 = "123 Main St",
                            AddressLine2 = "Apt 4B",
                            Amount = 50m,
                            BandId = 1,
                            City = "Anytown",
                            Date = new DateTime(2025, 1, 11, 15, 36, 44, 226, DateTimeKind.Utc).AddTicks(4114),
                        ...
                        new
                        {
                            TransactionId = new Guid("4f0741b9-b842-4727-88a3-cffbe77a02b9"),
                            AddressLine1 = "456 Elm St",
                            AddressLine2 = "Suite 1A",
                            Amount = 75m,
                            BandId = 2,
                            City = "Othertown",
                            Date = new DateTime(2025, 1, 11, 15, 36, 44, 226, DateTimeKind.Utc).AddTicks(4127),
