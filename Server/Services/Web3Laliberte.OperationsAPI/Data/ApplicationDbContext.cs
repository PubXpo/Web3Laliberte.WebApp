    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FAQ>(entity =>
        {
            ...
            entity.HasData(
                ...
                new FAQ { Id = 4, Question = "How can Web3 technologies promote transparency and trust in charity work?", Answer = "Web3 technologies like blockchain provide immutable records of transactions, ensuring transparency in how funds are used. This builds trust with donors, as they can verify where and how their contributions are spent." },
